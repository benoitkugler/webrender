...
//     article := unpack1(body)
//     div1, div2, div3 := unpack3(article)
// assertText.AssertEqual(t, unpack1(div1.Box().Children[0]) , "A")
// assertText.AssertEqual(t, unpack1(div2.Box().Children[0]) , "B")
// assertText.AssertEqual(t, unpack1(div3.Box().Children[0]) , "C")
//     (
//         div1.Box().PositionX ,
//         div2.Box().PositionX ,
//         div3.Box().PositionX ,
